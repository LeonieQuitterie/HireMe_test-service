...
// DỮ LIỆU GIẢ – CHẠY NGAY KHÔNG CẦN BACKEND
...
export default function ProfilePage() {
   ...
   const handleSave = () => {
      ...
      setIsEditing(false);
      alert("Đã lưu thành công! (Demo offline)");
   };
   ...
   const handleLogout = () => {
      if (confirm("Bạn có chắc muốn đăng xuất không?")) {
         alert("Đã đăng xuất thành công! (Demo)");
      }
   };
