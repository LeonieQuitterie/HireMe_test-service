                    ...
                    <div className="flex justify-center">
                        <Card className="w-full max-w-2xl hover:shadow-2xl transition-all duration-500 border-2 border-indigo-300 hover:border-purple-500 hover:scale-105 bg-white/80 backdrop-blur-sm"> {/* Giảm max-w-5xl → max-w-3xl */}
                            <CardHeader className="text-center pb-2">
                                ...
                                <CardTitle className="text-3xl font-bold text-indigo-800">Join Interview Room</CardTitle>
                                <CardDescription className="text-lg text-gray-600">
                                    Enter the 6-digit code to access your live video session
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="text-center space-y-6 p-8">
                                <div className="flex justify-center gap-4 mx-auto max-w-3xl"> {/* Giảm max-w-6xl → max-w-3xl */}
                                    {Array.from({ length: 6 }).map((_, i) => (
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.value && document.querySelectorAll('input')[i + 1]) {
                                ...
                                <Button
                                    size="lg"
                                    className="w-full max-w-md mx-auto bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold shadow-lg transform hover:scale-105 transition-all duration-300 h-14 text-lg"
